...
export declare const images: {
    ...
    readonly CeloDance: React.FC<React.SVGProps<SVGSVGElement>>;
...
export declare const Localhost: {
    readonly name: NetworkNames.Localhost;
 ...
 */
export declare const STATIC_NETWORK_WALLETS: WalletTypes[];
/**
