...
export declare type StableTokens = Omit<CeloTokens, 'CELO'>;
...
export declare const makeNetworkParams: (info: Network, CELO: GoldTokenWrapper) => Promise<AddEthereumChainParameter>;
...
export declare function switchToCeloNetwork(kit: ContractKit, network: Network, ethereum: Ethereum): Promise<void>;
